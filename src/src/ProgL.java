...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Thu May 02 10:05:32 ICT 2019
  */
public class ProgL extends java_cup.runtime.lr_parser {
  ...
  protected static final short _production_table[][] = 
    ...
    "\000\002\003\005\000\002\003\004\000\002\003\006" });
  ...
  protected static final short[][] _action_table = 
    ...
    "\004\012\ufffe\001\002\000\004\012\016\001\002\000\004" +
    "\012\ufffc\001\002\000\004\002\015\001\002\000\006\002" +
    "\uffff\010\012\001\002\000\004\012\ufffd\001\002\000\012" +
  ...
  protected static final short[][] _reduce_table = 
    unpackFromStrings(new String[] {
    "\000\016\000\010\002\006\003\007\004\004\001\001\000" +
    "\002\001\001\000\002\001\001\000\002\001\001\000\002" +
    "\001\001\000\002\001\001\000\002\001\001\000\006\003" +
    "\012\004\004\001\001\000\002\001\001\000\006\003\012" +
  ...
  public final java_cup.runtime.Symbol CUP$ProgL$do_action(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$ProgL$act_num)
        {
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 8: // declare ::= primitive TEXT ASSIGNER NUMBER 
            {
              Cupobj RESULT =null;
		...
		Cupobj p = (Cupobj)((java_cup.runtime.Symbol) CUP$ProgL$stack.elementAt(CUP$ProgL$top-3)).value;
		int tleft = ((java_cup.runtime.Symbol)CUP$ProgL$stack.elementAt(CUP$ProgL$top-2)).left;
		int tright = ((java_cup.runtime.Symbol)CUP$ProgL$stack.elementAt(CUP$ProgL$top-2)).right;
		String t = (String)((java_cup.runtime.Symbol) CUP$ProgL$stack.elementAt(CUP$ProgL$top-2)).value;
		 
              CUP$ProgL$result = parser.getSymbolFactory().newSymbol("declare",1, ((java_cup.runtime.Symbol)CUP$ProgL$stack.elementAt(CUP$ProgL$top-3)), ((java_cup.runtime.Symbol)CUP$ProgL$stack.peek()), RESULT);
            }
          return CUP$ProgL$result;

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 7: // declare ::= primitive TEXT 
            {
              Cupobj RESULT =null;
		...
		Cupobj p = (Cupobj)((java_cup.runtime.Symbol) CUP$ProgL$stack.elementAt(CUP$ProgL$top-1)).value;
		int tleft = ((java_cup.runtime.Symbol)CUP$ProgL$stack.peek()).left;
		int tright = ((java_cup.runtime.Symbol)CUP$ProgL$stack.peek()).right;
		String t = (String)((java_cup.runtime.Symbol) CUP$ProgL$stack.peek()).value;
		 
              CUP$ProgL$result = parser.getSymbolFactory().newSymbol("declare",1, ((java_cup.runtime.Symbol)CUP$ProgL$stack.elementAt(CUP$ProgL$top-1)), ((java_cup.runtime.Symbol)CUP$ProgL$stack.peek()), RESULT);
            }
          return CUP$ProgL$result;
		...
		Cupobj d2 = (Cupobj)((java_cup.runtime.Symbol) CUP$ProgL$stack.peek()).value;
              ...
              CUP$ProgL$result = parser.getSymbolFactory().newSymbol("declare",1, ((java_cup.runtime.Symbol)CUP$ProgL$stack.elementAt(CUP$ProgL$top-2)), ((java_cup.runtime.Symbol)CUP$ProgL$stack.peek()), RESULT);
            }
          return CUP$ProgL$result;
          ...
          case 5: // primitive ::= STRING 
            {
              ...
              CUP$ProgL$result = parser.getSymbolFactory().newSymbol("primitive",2, ((java_cup.runtime.Symbol)CUP$ProgL$stack.peek()), ((java_cup.runtime.Symbol)CUP$ProgL$stack.peek()), RESULT);
            }
          return CUP$ProgL$result;
		...
		Cupobj d = (Cupobj)((java_cup.runtime.Symbol) CUP$ProgL$stack.peek()).value;
              ...
              CUP$ProgL$result = parser.getSymbolFactory().newSymbol("initial",0, ((java_cup.runtime.Symbol)CUP$ProgL$stack.peek()), ((java_cup.runtime.Symbol)CUP$ProgL$stack.peek()), RESULT);
            }
          return CUP$ProgL$result;
		...
		Cupobj d = (Cupobj)((java_cup.runtime.Symbol) CUP$ProgL$stack.elementAt(CUP$ProgL$top-1)).value;
              ...
              CUP$ProgL$result = parser.getSymbolFactory().newSymbol("initial",0, ((java_cup.runtime.Symbol)CUP$ProgL$stack.elementAt(CUP$ProgL$top-1)), ((java_cup.runtime.Symbol)CUP$ProgL$stack.peek()), RESULT);
            }
          return CUP$ProgL$result;
